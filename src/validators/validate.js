 ...
 * If yes then it structures them and throws an {@link ApiError} which forwards the error to the {} middleware which throws a uniform response at a single place
 *
 */
